...
progress('Config file: {}', argv.config)
progress('Domain: {}', cfg.domain.name)
progress('Scenario: {}', cfg.domain.scenario)
progress('Input schema: {}', cfg.input_schema)
progress('Origin time: {}', cfg.origin_time)
...
progress('Domain resolution (dx,dy,dz):({},{},{})', cfg.domain.dx, cfg.domain.dy, cfg.domain.dz)
...
progress('Domain centre (x,y):({},{}) and origin (x,y):({},{})', cfg.domain.cent_x, cfg.domain.cent_y, origin_x, origin_y)
