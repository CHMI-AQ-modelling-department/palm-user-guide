...
dbuser='resler'
database = 'palm_trans'
schema = 'trans_legerova'
table_main = 'line_sources_main'
table_aux = 'line_sources_aux'
table_trans = 'trans_intensity'
table_out_pk = 's'
table_out_coef = 'coef'
out_path = '/storage/data/palm/dopravni_intenzity/legerovas_s6_transport'
